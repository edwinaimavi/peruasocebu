  ...
  public function store(Request $request)
    {
        ...
        $data = $request->validate([
            'code'   => 'nullable|string|max:10', // No obligatorio
            ...
            'email'  => 'required|email|unique:branches,email', // Email único
            'manager_user_id'  => 'nullable','integer','exists:users,id', // Email único
        ...
        $branch = Branch::create([
            ...
            'is_active'=> $data['is_active'], // el campo en BD es `is_active`
        ]);
